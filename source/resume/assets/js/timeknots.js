//Slightly Modified to accept a callback function on mouseover
...
var TimeKnots = {
  draw: function(id, events, options){
    var cfg = {
      ...
      dateDimension: true,
      onDateMouseover: false,
      onDateMouseout: false,
    };
    ...
    .attr("cx", function(d){
      ...
      if(cfg.onDateMouseover){
        cfg.onDateMouseover(d)
      } //trigger mouseover callback
      if(cfg.dateDimension){
